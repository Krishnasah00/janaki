        ...
        (m = function (e, t) {
            ...
            (t =
                ...
                o =
                    function (e, t, n, a, s) {
                        if ("string" == typeof e)
                            return p[e] ? p[e](t) : D(m(e, S(t)).f);
                        if (!e.splice) {
                            if (((b = e).deps && o(b.deps, b.callback), !t))
                                return;
        ...
        u("component/helper", ["./models"], function (u) {
            ...
            return (
                ...
                (a.getSubClass = function (e) {
                    ...
                    return (
                        n[e] ||
                            (n[e] = a.getClass(a.format("{0}{1}", u.name, e))),
                        n[e]
                    );
                }),
                a
                ...
                e = function (e) {
                    ...
                    if (e instanceof r == !1) {
                        if ("string" != typeof e && "number" != typeof e)
                            throw new Error(
                                "`date` option is invalid type. (date: " +
                                    e +
                                    ")."
                            );
                        e = r(e);
            ...
            return function (e) {
                ...
                return D.each(function () {
                    ...
                    !0 === D.settings.initialize &&
                        (k.initialize = k.current[0] =
                            k.dateManager.date.clone()),
                        (this.local = k),
                    ...
                    if (
                        (!0 === D.settings.buttons &&
                            (J = P(D.global.calendarButtonsHtml)).appendTo(
                                k.calendar
                            ),
                        ...
                        var n = N.getSubClass("wrapperActive"),
                            ...
                            s = void 0;
                        (C = P(k.calendarWrapperHtml)).bind(
                            "click",
                            function (e) {
                                e.stopPropagation();
                            }
                                ...
                                .bind("click", function (e) {
                                    e.preventDefault(),
                                        ...
                                        (s = P(
                                            ...
                                            (s = P(
                                                k.calendarWrapperOverlayHtml
                                            )).appendTo("body"),
                                        s
                                            .unbind(
                                                "click." + N.getClass(q.name)
                                            )
                                            .bind(
                                                "click." + N.getClass(q.name),
                                                function (e) {
                            ...
                            C.unbind(
                                ...
                                "cancel." +
                                    ...
                                    N.getClass(q.name),
                                function () {
                                    s.removeClass(a).hide(),
                                        C.removeClass(n).hide();
                                }
                            );
                    }
                    var M = function () {
                    ...
                    (k.renderer = function () {
                        if (
                            ...
                            k.calendar
                                .find("." + z.top + "-year")
                                .text(k.dateManager.year),
                            k.calendar
                                .find("." + z.top + "-month")
                                .text(
                                    D.settings.monthsLong[
                                        k.dateManager.month - 1
                                    ]
                                ),
                            k.calendar
                                ...
                                if (t.hasClass(z.button + "-apply")) {
                                    ...
                                    if (!0 === D.settings.toggle)
                                        ...
                                        n =
                                            null === k.current[0]
                                                ? ""
                                                : T(k.current[0]).format(
                                                      D.settings.format
                                                  );
                                    !0 === k.input &&
                                        s.val(n).triggerHandler("change"),
                                        "function" == typeof D.settings.apply &&
                                            D.settings.apply.call(
                                                k.calendar,
                                                k.current,
                                                k
                                            ),
                                        C.triggerHandler(
                                            "apply." + N.getClass(q.name)
                                        );
                        ...
                        for (
                            var g = [],
                                ...
                                d =
                                    null === D.settings.minDate
                                        ? null
                                        : T(D.settings.minDate),
                                f =
                                    null === D.settings.maxDate
                                        ? null
                                        : T(D.settings.maxDate),
                                o = 0;
                            o < a;
                            o++
                        ) {
                            ...
                            var l = function (e) {
                                    ...
                                    if (0 < D.settings.enabledDates.length)
                                        -1 ===
                                            P.inArray(
                                                n,
                                                D.settings.enabledDates
                                            ) &&
                                            a.addClass(
                                                N.getSubClass("unitDisabled")
                                            );
                                    else if (
                                        0 <
                                            D.settings.disabledWeekdays
                                                .length &&
                                        -1 !==
                                            P.inArray(
                                                t.weekday(),
                                        ...
                                        -1 !==
                                        P.inArray(n, D.settings.disabledDates)
                                    )
                                        a.addClass(
                                            N.getSubClass("unitDisabled")
                                        );
                                    else if (
                                        0 < D.settings.disabledRanges.length
                                    )
                                        for (
                                            var s =
                                                    D.settings.disabledRanges
                                                        .length,
                                                r = 0;
                                            r < s;
                                            r++
                                    ...
                                    if (
                                        ...
                                        "object" ===
                                            H(D.settings.scheduleOptions) &&
                                        "object" ===
                                            H(D.settings.scheduleOptions.colors)
                                    ) {
                                        var i = D.settings.schedules.filter(
                                                function (e) {
                                                    return e.date === n;
                                                }
                                            ),
                                    ...
                                    a.bind("click", function (e) {
                                        ...
                                        if (
                                            ...
                                            !0 === D.settings.multiple &&
                                                ...
                                                M.call()),
                                                0 <
                                                    D.settings.schedules
                                                        .length &&
                                                    (k.storage.schedules =
                                                        D.settings.schedules.filter(
                                                            function (e) {
                                                                return (
                                                                    e.date === n
                                                                );
                                        ...
                                        var f = function (e) {
                                            k.date.all.push(e),
                                                !(function (e) {
                                                    if (
                                                        -1 !==
                                                        D.settings.disabledDates.indexOf(
                                                            e
                                                        )
                                                    )
                                                        return !1;
                                                    ...
                                                    return (
                                                        -1 ===
                                                        D.settings.disabledWeekdays.indexOf(
                                                            r
                                                        )
                                                    );
                                                })(T(e))
                                        ...
                                        !1 === s &&
                                            ((k.initialize = null),
                                            "function" ==
                                                typeof D.settings.select &&
                                                D.settings.select.call(
                                                    t,
                                                    k.current,
                                                    k
                                                )),
                                            "function" ==
                                                typeof D.settings.click &&
                        ...
                        for (
                            var m = r + 1;
                            g.length < 5 * D.settings.weeks.length;
                            m++
                        ) {
                        ...
                        k.renderer.call(),
                        (y[0][q.name] = k),
                        "function" == typeof D.settings.init &&
                            D.settings.init.call(y, k);
                });
            };
        }
    ),
            ...
            function (s, e, r) {
                return function (e) {
                    ...
                    if (
                        ...
                        0 < Object.keys(a.languages).length)
                    ) {
                        var t = function (t) {
                            var n = a.languages[t];
                            if (
                            ...
                            if (n.monthsLong) {
                                if (n.monthsLong.length < 12)
                                    return (
                                        console.error(
                                            "`monthsLong` must have least 12 items."
                                        ),
                                        "break"
                                    );
                            ...
                            if (n.months) {
                                if (n.months.length < 12)
                                    return (
                                        console.error(
                                            "`months` must have least 12 items."
                                        ),
                                        "break"
                                    );
                                12 !== n.months.length &&
                            ...
                            -1 === s.languages.supports.indexOf(t) &&
                                ...
                                [
                                    ...
                                    s.languages[e][t] &&
                                        ...
                                        (s.languages[e][t] =
                                            n[e] ||
                                            s.languages[e][t.defaultLanguage]);
                                });
                        };
