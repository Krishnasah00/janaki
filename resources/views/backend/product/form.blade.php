...
@else
    ...
    <div class="modal-header">
        <h5 class="modal-title">
            {{ !empty($prevProductDetails->id) ? 'Update Existing Product Details' : 'Create New Product' }}
        </h5>
        <button type="button" class="close" data-dismiss="modal"><span style="font-size: 25px !important;">×</span>
        </button>
    </div>
    <div class="modal-body">
        ...
        <div class="form-validation">
            <form action="{{ route('admin.products.save') }}" class="form-valide" method="POST" id="productForm"
                enctype="multipart/form-data">

                <input type="hidden" name="id" type="id" value="{{ @$prevProductDetails->id }}">
                <div class="row">
                    <div class="col-xl-6">

                        <!-- Starts :: Name -->
                        <div class="form-group row">
                            <label class="col-lg-12 col-form-label" for="name">Name
                                <span class="text-danger">*</span>
                            </label>
                            <div class="col-lg-12">
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="Enter a product name" value="{{ @$prevProductDetails->name }}">
                            </div>
                        </div>
                        <!-- Ends :: Name -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12">
                                <input type="number" class="form-control" id="mobile_number" name="mobile_number"
                                    placeholder="Enter mobile number" value="{{ @$prevProductDetails->mobile_number }}">
                            </div>
                        </div>
                        <!-- Ends :: Mobile Number-->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12">
                                <textarea class="form-control" id="address" name="address" rows="5" placeholder="Enter your full address">{{ @$prevProductDetails->address }}</textarea>
                            </div>
                        </div>
                        <!-- Ends :: Address -->
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12">
                                <input type="email" class="form-control" id="email" name="email"
                                    placeholder="Enter your valid email address" value="{{ @$prevProductDetails->email }}">
                            </div>
                        </div>
                        <!-- Ends :: Email Address -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12 img-rectangle">
                                ...
                                if (!empty(@$prevProductDetails->profile_picture) && Storage::disk('public')->exists('user-account/' . @$prevProductDetails->profile_picture)) {
                                    $photo = asset('storage/user-account/' . $prevProductDetails->profile_picture);
                                }
                                ?>
...
<script>
    var userId = "{{ @$prevProductDetails->id }}".trim();
